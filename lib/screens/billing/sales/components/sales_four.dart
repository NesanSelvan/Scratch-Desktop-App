...
class SalesScreen4 extends StatefulWidget {
  @override
  State<SalesScreen4> createState() => _SalesScreen4State();
}

class _SalesScreen4State extends State<SalesScreen4> {
  ...
  void addBillToSalesList() {
    if (salesBillingFourController.selectedProductModel == null) {
      ...
      final company = companyDB
          ...
          .toList()[0];
      final rate = double.parse(salesBillingFourController.rateController.text);
      final product = ProductModel(
        differentPriceList: [],
        id: const Uuid().v4(),
        code: "",
        productName: salesBillingFourController.productController.text,
        categoryId: category.id,
        unitId: salesBillingFourController.selectedUnitModel!.id!,
        purchasePrice: 0,
        sellingPrice: rate,
        wholesale: rate,
        retail: rate,
      ...
      salesBillingFourController.addSelectedProductModel = product;
      productDB.addProductToDb(product);
    }
    salesBillingFourController.addSelectedSalesProductModel();
    salesBillingFourController.productController.clear();
    salesBillingFourController.getAllProducts();
    salesBillingFourController.update();
    salesBillingFourController.productNode.requestFocus();
  }

  Widget buildInkWell(
    SalesProductModel e,
    SalesBillingFourController controller,
  ...
  Widget build(BuildContext context) {
    ...
    salesBillingFourController.onInit();
    salesBillingFourController.getAllProducts();
    salesBillingFourController.getAllCustomers();
    return GetBuilder<SalesBillingFourController>(
      builder: (controller) {
        return Container(
          width: CustomScreenUtility(context).width,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      CustomTypeAhead<ProductModel>(
                                        ...
                                        onF2: () async {
                                          await salesBillingFourController
                                              .addBillToDB(
                                            salesBillingController,
                                            PrinterEnum.Normal,
                                          );
                              ...
                              CustomTypeAhead<UnitModel>(
                                ...
                                onEditingComplete: () {
                                  if (salesBillingFourController
                                          .selectedUnitModel !=
                                      null) {
                                    salesBillingFourController.unitController
                                        .text = salesBillingFourController
                                ...
                                onSuggestionSelected: (suggestion) {
                                  ...
                                  salesBillingFourController.productController
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                                ...
                                child: CustomTypeAhead<CustomerModel>(
                                  ...
                                  onEnter: () {
                                    if (salesBillingFourController
                                        ...
                                        null) {
                                      debugPrint(
                                        'Selected Customer :P ${salesBillingFourController.selectedCustomerModel}',
                                      );
                                      salesBillingFourController
                      ...
                      GetBuilder<SalesBillingFourController>(
                        builder: (controller) {
                          return Column(
