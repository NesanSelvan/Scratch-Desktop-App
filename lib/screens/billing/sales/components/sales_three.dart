...
class SalesScreen3 extends StatefulWidget {
  @override
  State<SalesScreen3> createState() => _SalesScreen3State();
}

class _SalesScreen3State extends State<SalesScreen3> {
  ...
  void addBillToSalesList() {
    if (salesBillingThreeController.selectedProductModel == null) {
      ...
      final company = companyDB
          ...
          .toList()[0];
      final rate =
          double.parse(salesBillingThreeController.rateController.text);
      final product = ProductModel(
        differentPriceList: [],
        id: const Uuid().v4(),
        code: "",
        productName: salesBillingThreeController.productController.text,
        categoryId: category.id,
        unitId: salesBillingThreeController.selectedUnitModel!.id!,
        purchasePrice: 0,
        sellingPrice: rate,
        wholesale: rate,
        retail: rate,
      ...
      salesBillingThreeController.addSelectedProductModel = product;
      productDB.addProductToDb(product);
    }
    salesBillingThreeController.addSelectedSalesProductModel();
    salesBillingThreeController.productController.clear();
    salesBillingThreeController.getAllProducts();
    salesBillingThreeController.update();
    salesBillingThreeController.productNode.requestFocus();
  }

  Widget buildInkWell(
    SalesProductModel e,
    SalesBillingThreeController controller,
  ...
  Widget build(BuildContext context) {
    ...
    salesBillingThreeController.onInit();
    salesBillingThreeController.getAllProducts();
    salesBillingThreeController.getAllCustomers();
    return GetBuilder<SalesBillingThreeController>(
      builder: (controller) {
        return Container(
          width: CustomScreenUtility(context).width,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      CustomTypeAhead<ProductModel>(
                                        ...
                                        onF2: () async {
                                          await salesBillingThreeController
                                              .addBillToDB(
                                            salesBillingController,
                                            PrinterEnum.Normal,
                                          );
                                        ...
                                        onEditingComplete: () {
                                          if (salesBillingThreeController
                                                  .selectedProductModel !=
                                              null) {
                                            salesBillingThreeController
                                                    .productController.text =
                              ...
                              CustomTypeAhead<UnitModel>(
                                ...
                                onEditingComplete: () {
                                  if (salesBillingThreeController
                                          .selectedUnitModel !=
                                      null) {
                                    salesBillingThreeController.unitController
                                        .text = salesBillingThreeController
                                ...
                                onSuggestionSelected: (suggestion) {
                                  ...
                                  salesBillingThreeController.productController
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                                ...
                                child: CustomTypeAhead<CustomerModel>(
                                  ...
                                  onEnter: () {
                                    if (salesBillingThreeController
                                        ...
                                        null) {
                                      debugPrint(
                                        'Selected Customer :P ${salesBillingThreeController.selectedCustomerModel}',
                                      );
                                      salesBillingThreeController
                      ...
                      GetBuilder<SalesBillingThreeController>(
                        builder: (controller) {
                          return Column(
