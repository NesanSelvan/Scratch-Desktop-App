...
class EstimateReceiptScreen extends StatelessWidget {
  EstimateReceiptScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return RawKeyboardListener(
      ...
      child: Scaffold(
        body: GetBuilder<EstimateReceiptController>(
